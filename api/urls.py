...
from user.views import ListUser, DetailUser, UserUploadAvatar, UserActiveCodeView, UserTicketsView, AdminActiveCodeView, AdminGetTotalScore, AdminGetTotalScoreUnit
